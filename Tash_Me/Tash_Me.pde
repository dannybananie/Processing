...
void setup() {
  ...
  PImage friends = loadImage("mr-bean-secret-photo-album-20-1.jpg");  // 2. Change this to match the name of your photo. 
...
background(friends);
  ...
  mustache = loadImage("black.png"); // 5. Change this to match your file name.
}
